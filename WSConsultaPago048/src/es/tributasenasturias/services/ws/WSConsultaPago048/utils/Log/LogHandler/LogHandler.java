	...
	private void log(SOAPMessageContext context)
	{
        ...
        synchronized (this)
        {
	     try 
	     {
	         ...
	         if (this.getClass().getName().equals("es.tributasenasturias.services.ws.WSConsultaPago048.utils.Log.LogHandler.ServerLogHandler"))
	        	 tipoLog = "SOAP_SERVER";
	         else 
	        	 tipoLog = "SOAP_CLIENT";
	         String log = "=========================>WSConsultaPago048:: "+ tipoLog + "::Inicio ::+"+direccion+"::"+ ip + " :: "+today+endl;
	         log += soapMessage + endl;
	         log +="=========================>WSConsultaPago048::" + tipoLog + "::Fin ::"+direccion +"::" + today + endl;
