...
public class SoapServerHandler implements SOAPHandler<SOAPMessageContext> {
	...
	private void log(SOAPMessageContext context) 
	{
		...
		try
		{
			...
			idSesion=(String)context.get(Constantes.IDLLAMADA);
			if (idSesion==null)
			{
		...
		catch (PreferenciasException ex)
		{
			...
			System.err.println ("Consulta de datos censales: Error de preferencias en manejador SOAP ("+SoapServerHandler.class.getName()+":"+ex.getMessage());
			SOAPUtils.generateSOAPErrMessage(context.getMessage(),"Error en proceso de mensaje SOAP.","0001","SOAP Handler I/O Exception", true);
		}
	}
