...
public class Datos 
{
	...
	{										
		...
		{			
			...
			{								
				if (preferencias.getDebug().equals("1"))
					Logger.info ("Se utiliza el endpoint de lanzadera: " + endPointLanzador);
			...
			else
			{
				...
				if (preferencias.getDebug().equals("1"))
					Logger.info ("Se utiliza el endpoint de lanzadera por defecto: " + bpr.getRequestContext().get (javax.xml.ws.BindingProvider.ENDPOINT_ADDRESS_PROPERTY));
			}
