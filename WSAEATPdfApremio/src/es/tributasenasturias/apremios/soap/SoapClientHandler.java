...
public class SoapClientHandler implements SOAPHandler<SOAPMessageContext> {
	...
	private void log(SOAPMessageContext context)
	{
		...
		catch (javax.xml.soap.SOAPException ex)
		{
			...
			Utils.generateSOAPErrMessage(context.getMessage(), "Error en proceso de comunicación Traslado Máquina <--> Servicio Remoto."	, "0002", "SOAP Handler", true);
		}
		...
		catch (PreferenciasException ex)
		{
			...
			System.err.println ("Envío de Pdf de Apremio: Error de preferencias en manejador SOAP ("+SoapClientHandler.class.getName()+":"+ex.getMessage());
			Utils.generateSOAPErrMessage(context.getMessage(), "Error en proceso de comunicación Traslado Máquina <--> Servicio Remoto."	, "0002", "SOAP Handler", true);
		}
	}
	@Override
