...
import es.tributasenasturias.services.ws.custodiaimagenes.Constantes;
import es.tributasenasturias.services.ws.custodiaimagenes.utils.log.GenericAppLogger;
...
public class LogHandler implements SOAPHandler<SOAPMessageContext>{
	...
	private void log(SOAPMessageContext context)
	{
        ...
        String idLlamada = (String) context.get(es.tributasenasturias.services.ws.custodiaimagenes.Constantes.ID_LLAMADA);
   	 	if (idLlamada==null) {
   		 System.out.println ("WSCustodiaImagenes:: Error en manejador de SOAP_SERVER, no se encuentra identificador de llamada");
   		 return;
   	 	}
	   	Preferencias pref= (Preferencias) context.get(Constantes.PREFERENCIAS);
		if (pref==null) 
		{
		 System.out.println("WSCustodiaImagenes::Error en manejador de SOAP_SERVER, no se encuentran preferencias de la llamada");
		 return;
		}
	    try 
	     {
	    	 ...
	    	 //16/12/2020. Se hace después de comprobar si es necesario grabar, ya que es una operación costosa en  mensajes grandes.
	         ...
	         {
	        	 //No hay log de cliente por el momento. En ese caso salimos.
	        	 return;
	         }
	         String log = "=========================>WSCustodiaImagenes:: "+ tipoLog + "::" + idLlamada +"::Inicio ::+"+direccion+"::"+ ip + " :: "+today+endl;
	         log += soapMessage + endl;
	         log +="=========================>WSCustodiaImagenes::" + tipoLog + "::" + idLlamada + "::Fin ::"+direccion +"::" + today + endl;
