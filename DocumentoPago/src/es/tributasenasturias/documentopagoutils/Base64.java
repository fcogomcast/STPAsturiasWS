...
{	
    ...
    */
    ...
    public static void main(String[] args)
    {
        ...
        if (args.length == 0)
        {
        	es.tributasenasturias.documentopagoutils.Logger.debug("usage:  java Base64 [-d[ecode]] filename",es.tributasenasturias.documentopagoutils.Logger.LOGTYPE.APPLOG);
            System.exit(0);
        }
