 ...
 *
 */
public class GenerarDocsANCERTException extends Exception {
	...
	public GenerarDocsANCERTException(String error, Throwable original){
		this._error = error;
		this._original = original;
	}
	public GenerarDocsANCERTException (String error)
	{
		this._error = error;
		_original=null;
	}
