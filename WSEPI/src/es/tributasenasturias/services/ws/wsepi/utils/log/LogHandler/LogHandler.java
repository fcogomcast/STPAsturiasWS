...
import es.tributasenasturias.services.ws.wsepi.utils.log.GenericAppLogger;
...
public class LogHandler implements SOAPHandler<SOAPMessageContext>{
	...
	private void log(SOAPMessageContext context)
	{
        ...
        String idLlamada = (String) context.get(Constantes.ID_LLAMADA);
   	 	if (idLlamada==null) {
   		 System.out.println ("WSEPI:: Error en manejador de SOAP_SERVER, no se encuentra identificador de llamada");
   		 return;
   	 	}
	   	Preferencias pref= (Preferencias) context.get(Constantes.PREFERENCIAS);
		if (pref==null) 
		{
		 System.out.println("WSEPI::Error en manejador de SOAP_SERVER, no se encuentran preferencias de la llamada");
		 return;
		}
	    try 
	     {
	    	 ...
	    	 // 16/12/2020. Se declara si se va a utilizar para hacer debug, porque es una operación costosa con mensajes grandes.
	         ...
	         String log = "=========================>WSEPI:: "+ tipoLog + "::" + idLlamada +"::Inicio ::+"+direccion+"::"+ ip + " :: "+today+endl;
	         log += soapMessage + endl;
	         log +="=========================>WSEPI::" + tipoLog + "::" + idLlamada + "::Fin ::"+direccion +"::" + today + endl;
