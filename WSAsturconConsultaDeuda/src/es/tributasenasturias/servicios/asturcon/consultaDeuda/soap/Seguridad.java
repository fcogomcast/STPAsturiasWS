...
import es.tributasenasturias.servicios.asturcon.consultaDeuda.Utils.Base64;
...
import es.tributasenasturias.servicios.asturcon.consultaDeuda.wssecurity.WSSecurityFactory;
...
public class Seguridad implements SOAPHandler<SOAPMessageContext> {
	...
	/**
	 * Comprueba si el certificado es válido .
	 ...
	 * @throws SeguridadException En caso de no poder comprobar la validez.
	 */
...
//						//Soap Fault, la seguridad no deja pasar el mensaje.
				...
				if ("S".equalsIgnoreCase(pref.getValidaPermisosServicio()))
				{
					...
					log.info ("Se procede a comprobar si las persona relacionada con el certificado tiene permisos sobre el servicio.");
