...
/**
 * Clase para poder realizar log con rotación diaria
 * @author crubencvs
 *
 */
public class DailyLogger implements ILog{
	 ...
	 * 
	 */
	private File getDailyLog(String rutaFichero){
		String nombreLog;
		File ruta= new File(rutaFichero);
		String original = ruta.getName();
		Date now= new Date();
		...
		return new File(ruta.getParent()+File.separator+nombreLog);
	}
	 ...
	 * @param idSesion
	 */
	public DailyLogger(NIVEL_LOG nivel,String ficheroLog, String idSesion)
	{
		this.nivel= nivel;
	 ...
	 * @param ficheroLog
	 */
	public DailyLogger(NIVEL_LOG nivel, String ficheroLog)
	{
	 ...
	 * @param idSesion
	 */
	public DailyLogger(String nivel,String ficheroLog, String idSesion)
	{
	 ...
	 * @param ficheroLog
	 */
	public DailyLogger(String nivel, String ficheroLog)
	{
		this(nivel, ficheroLog, null);
	}
	/**
	...
	public void doLog(String message, NIVEL_LOG level)
	{
        ...
        try
        {
        	File dest= getDailyLog(this.fichero);
        	String completeMsg="";
