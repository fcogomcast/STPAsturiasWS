...
public class ConversorParametrosLanzador 
{
	...
	/**
	 * Resetea los parámetros. Puede ser necesario para optimizar la llamada, porque si se guarda 
	 * una referencia como variable de clase en la clase de entrada al servicio web, el contenido de 
	 * este objeto permanece en memoria hasta la siguiente llamada del servicio. Esto es así porque
	 * la clase de entrada al servicio se convierte de forma automática a un singleton, es decir,
	 * hay una sola instancia y por tanto no se libera nunca.
	 * También se utiliza para eliminar los parámetros antiguos antes de una nueva llamada a procedimiento.
	 */
	private void resetParameters(){
		this.m_formatoParametros.clear();
		this.m_tipoParametros.clear();
		this.m_valorParametros.clear();
	}
	/**
