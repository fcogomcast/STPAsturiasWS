...
/**
 * Logger realiza las tareas de abrir, escribir y cerrar el fichero de log del web service de escrituras enviadas por ancert
 * 
 * Se utilizará el log, siempre que la preferencia Debug tenga el valor 1.
 * 
 * El fichero de log se llama Application.log y se encuentra en la carpeta EscriturasAncert. 
 *
 */
public final class Logger 
{
	private final static String LOG_FILE = "Aplication.log";
	private final static String LOG_DIR = "proyectos//WSEscriturasAncert";
	...
	public final synchronized static void doLog(String message, LEVEL level)
	{
        ...
        {
            Date today = new Date();
            String completeMsg = "EscriturasAncert :: " + today + " :: " + level + " :: " + message;
