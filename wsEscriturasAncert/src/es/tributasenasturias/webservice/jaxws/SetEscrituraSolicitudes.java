...
@XmlRootElement(name = "setEscrituraSolicitudes", namespace = "http://webservice.tributasenasturias.es/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "setEscrituraSolicitudes", namespace = "http://webservice.tributasenasturias.es/", propOrder = {
    "codNotario",
    "codNotaria",
    "numProtocolo",
    "protocoloBis",
    ...
    "firmaEscritura",
    "docEscritura",
    "autorizadoDiligencias",
    "gestionarSolicitud"
})
public class SetEscrituraSolicitudes {
    ...
    @XmlElement(name = "autorizadoDiligencias", namespace = "")
    private String autorizadoDiligencias;
    @XmlElement(name = "gestionarSolicitud", namespace = "")
    private String gestionarSolicitud;
     ...
     *     returns String
     */
    public String getAutorizadoDiligencias() {
        return this.autorizadoDiligencias;
    }

    /**
     * 
     * @param autorizadoDiligencias
     *     the value for the autorizadoDiligencias property
     */
    public void setAutorizadoDiligencias(String autorizadoDiligencias) {
        this.autorizadoDiligencias = autorizadoDiligencias;
    }
     ...
     *     returns String
     */
    public String getGestionarSolicitud() {
        return this.gestionarSolicitud;
    }

    /**
     * 
     * @param gestionarSolicitud
     *     the value for the gestionarSolicitud property
     */
    public void setGestionarSolicitud(String gestionarSolicitud) {
        this.gestionarSolicitud = gestionarSolicitud;
    }
