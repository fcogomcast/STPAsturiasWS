...
public class ConversorParametrosLanzador 
{
	...
	/**
	 * Devuelve una lista con los nodos con determinado nombre
	 * @param nombreNodo Nombre del nodo
	 * @return
	 */
	public String[] getNodosResultadoX(String nombreNodo)
	{
		...
		try {
			...
			for (int i=0;i<nodos.getLength();i++){
				valores.add(XMLDOMUtils.getNodeText(nodos.item(i)));
			}
			return valores.toArray(new String[1]);
		} catch(Exception e){
			return null;
		}
	}
