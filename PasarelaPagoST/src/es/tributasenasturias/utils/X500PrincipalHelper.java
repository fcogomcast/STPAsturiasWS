...
public class X500PrincipalHelper {
	...
	public final static String attrUID = "UID"; //$NON-NLS-1$
        public final static String attrSERIALNUMBER = "2.5.4.5"; //$NON-NLS-1$
	...
	public String getOU() {
		...
		return findPart(attrSERIALNUMBER);
	}
	/**
	...
	public ArrayList<String> getAllValues(String attributeID) {
		...
		for (Iterator<ArrayList<String>> iter = rdnNameArray.iterator(); iter.hasNext();) {
			ArrayList<String> nameList = iter.next();
