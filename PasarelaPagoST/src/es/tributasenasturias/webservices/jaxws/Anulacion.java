...
@XmlRootElement(name = "Anulacion", namespace = "http://webservices.tributasenasturias.es/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Anulacion", namespace = "http://webservices.tributasenasturias.es/", propOrder = {
    "origen",
    "modalidad",
    "cliente",
    "emisora",
