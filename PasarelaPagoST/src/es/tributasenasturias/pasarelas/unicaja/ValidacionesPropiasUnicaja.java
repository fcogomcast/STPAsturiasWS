...
/**
 * Realiza las validaciones propias de Unicaja. Estas validaciones sólo se efectuarán cuando
 * se vayan a realizar las operaciones contra la pasarela.
 * @author crubencvs
 *
 */
public class ValidacionesPropiasUnicaja {
	
	private ValidacionesPropiasUnicaja(){};
	/**
	...
	/**
	 * Realiza las comprobaciones propias de Unicaja.
	 * @param datosProceso
	 * @param pref
	 * @return
	 * @throws PasarelaPagoException
	 */
	public static boolean validacionesUnicaja (DatosProceso datosProceso, PreferenciasUnicaja pref) throws PasarelaPagoException
	{
		boolean valido=true;
		try
		{
