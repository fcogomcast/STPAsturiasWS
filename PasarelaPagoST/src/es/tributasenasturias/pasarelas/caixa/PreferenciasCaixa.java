...
/**
 * Datos de preferencias de la Caixa. Mismos valores que en el fichero de preferencias creado a tal 
 * efecto.
 * @author crubencvs
 *
 */
public final class PreferenciasCaixa extends PreferenciasPasarela{

	private static final String ERROR_PREFERENCIAS = "Error en lectura de preferencias de LaCaixa:";
	...
	/**
	 * 
	 * @return the calcularIBAN
	 */
	public String getCalcularIBAN(){
		return calcularIBAN;
	}
	/**
	 ...
	 */
	public PreferenciasCaixa(String ficheroPreferencias) throws PasarelaPagoException
	{
		super ();
		try
		{
			...
			if (nodos.getLength()>0)
			{
				...
				this.calcularIBAN= xpath.evaluate("entry[@key='CalcularIBAN']/@value", nodos.item(0));
			}
		}
