...
/**
 * Realiza las validaciones propias de la Caixa. Estas validaciones sólo se efectuarán cuando
 * se vayan a realizar las operaciones contra la pasarela.
 * @author crubencvs
 *
 */
public class ValidacionesPropiasCaixa {
	
	private ValidacionesPropiasCaixa(){};
	/**
	...
	/**
	 * Realiza las comprobaciones propias de la Caixa.
	 * @param datosProceso
	 * @param pref
	 * @return
	 * @throws PasarelaPagoException
	 */
	public static boolean validacionesCaixa(DatosProceso datosProceso, PreferenciasCaixa pref) throws PasarelaPagoException
	{
		boolean valido=true;
		try
		{
