...
import es.tributasenasturias.conversor.MensajesCajaRural;
...
/**
 * Convierte la entrada de servicio a una entrada de Caja Rural, y la salida de
 * Caja Rural a una salida de servicio.
 * 
 * @author crubencvs
 * 
 */
public final class ConversorCajaRural {
	
	private static final String MASCARA_ANIO_MES_DIA = "yyyy-MM-dd";
	private static final String MASCARA_ANIO_MES = "yyyy-MM";
	private ConversorCajaRural(){}
	/**
	 * Crea un mensaje de pago a Caja Rural en función de los datos de entrada de
	 * 
	 * la petición.
	 * 
	 * @param datosProceso
	 ...
	 */
	public static PAGOIN peticionACajaRural(DatosProceso datosProceso, PreferenciasCajaRural pref)
		...
		try {
			...
			throw new ConversionExcepcion(
					"Error de conversión de fecha en mensaje de Caja Rural:"
							+ e.getMessage(), e);
		} catch (Exception e) {
			throw new ConversionExcepcion(
					"Error de conversión a mensaje de Caja Rural:"
							+ e.getMessage(), e);
		}
		return pago;
	}
	/**
	 * Crea un mensaje de consulta de cobro a Caja Rural. 
	 * @param datosProceso Datos del proceso, incluirá la petición al servicio web.
	 * @return
	 * @throws ConversionExcepcion
	 */
	public static CONSULTACOBROSIN consultaACajaRural(DatosProceso datosProceso, PreferenciasCajaRural pref)
			throws ConversionExcepcion {
	...
	/**
	 * Crea un mensaje de anulación a Caja Rural en función de los datos de entrada de
	 * la petición.
	 * 
	 ...
	 * @throws ConversionException
	 */
	public static ANULACIONIN anulacionACajaRural(DatosProceso datosProceso, PreferenciasCajaRural pref)
			throws ConversionExcepcion {
		DatosEntradaServicio peticionServicio= datosProceso.getPeticionServicio();
	...
	/**
	 * Convierte la respuesta de Caja Rural a código de respuesta del servicio, utilizando el fichero de mapeo de errores.
	 * @param datosComunicacion Datos de la comunicación con Caja Rural
	 * @param resultadoPorDefecto Código de resultado si no se encuentra en el mapeo de mensajes.
	 */
	public static void  resultadoCajaRuralAServicio(DatosComunicacion datosComunicacion, String resultadoPorDefecto)
	{
		String resCajaRural = datosComunicacion.getResultadoComunicacion();
		java.util.List<MensajesCajaRural> mapa= new ConversorRespuestaCajaRural().getErrorCajaRural(resCajaRural);
		if (mapa!=null)
		{
			MensajesCajaRural men = mapa.get(0);
