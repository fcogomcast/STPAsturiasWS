...
/**
 * Datos de preferencias de BBVA. Mismos valores que en el fichero de preferencias creado a tal 
 * efecto.
 * @author crubencvs
 *
 */
public final class PreferenciasBBVA extends PreferenciasPasarela{

	private static final String ERROR_PREFERENCIAS = "Error en lectura de preferencias de BBVA:";
	 ...
	 */
	public PreferenciasBBVA(String ficheroPreferencias) throws PasarelaPagoException
	{
		super ();
		try
		{
