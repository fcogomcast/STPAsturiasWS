...
public final class ConversorBBVA {
	...
	/**
	 * Crea un mensaje de pago a BBVA en función de los datos de entrada de
	 * 
	 * la petición.
	 * 
	 * @param datosProceso
	...
	public static PAGOIN peticionABBVA(DatosProceso datosProceso, PreferenciasBBVA pref)
		...
		try {
			...
			throw new ConversionExcepcion(
					"Error de conversión de fecha en mensaje de BBVA:"
							+ e.getMessage(), e);
		} catch (Exception e) {
			throw new ConversionExcepcion(
					"Error de conversión a mensaje de BBVA:"
							+ e.getMessage(), e);
		}
		return pago;
	}
	...
	/**
	 * Crea un mensaje de anulación a BBVA en función de los datos de entrada de
	 * la petición.
	 * 
	...
	/**
	 * Convierte la respuesta de BBVA a código de respuesta del servicio, utilizando el fichero de mapeo de errores.
	 * @param datosComunicacion Datos de la comunicación con BBVA
