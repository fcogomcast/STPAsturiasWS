...
/**
 * Realiza las validaciones propias de BBVA. Estas validaciones sólo se efectuarán cuando
 * se vayan a realizar las operaciones contra la pasarela.
 * @author crubencvs
 *
 */
public class ValidacionesPropiasBBVA {
	
	private ValidacionesPropiasBBVA(){};
	/**
	...
	/**
	 * Realiza las comprobaciones propias de BBVA.
	 * @param datosProceso
	 * @param pref
	 * @return
	 * @throws PasarelaPagoException
	 */
	public static boolean validacionesBBVA(DatosProceso datosProceso, PreferenciasBBVA pref) throws PasarelaPagoException
	{
		boolean valido=true;
		try
		{
