...
public final class ValidadorOrigenPortalAnulacion implements IValidador<DatosEntradaServicio>{
	...
	public ResultadoIValidador validar(DatosEntradaServicio datos)
		...
		if (datos.getOrigen().equals(Constantes.getOrigenPortal()) || datos.getOrigen().equals(Constantes.getOrigenS1()))
		{
			...
			// Se eliminan las comprobaciones de medio de pago en la operación de anulación,
			// para poder llamarla desde Tributas.
