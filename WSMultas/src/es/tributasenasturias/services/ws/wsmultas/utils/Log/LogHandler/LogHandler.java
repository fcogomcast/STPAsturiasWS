...
import es.tributasenasturias.services.ws.wsmultas.utils.Log.GenericAppLogger;
	...
	private void log(SOAPMessageContext context)
	{
        ...
        synchronized (this)
        {
	     try 
	     {
	         ...
	         if (this.getClass().getName().equals("es.tributasenasturias.services.ws.WSConsultaDoinDocumentos.utils.Log.LogHandler.ServerLogHandler"))
	        	 tipoLog = "SOAP_SERVER";
	         else 
	        	 tipoLog = "SOAP_CLIENT";
	         String log = "=========================>WSConsultaDoinDocumentos:: "+ tipoLog + "::Inicio ::+"+direccion+"::"+ ip + " :: "+today+endl;
	         log += soapMessage + endl;
	         log +="=========================>WSConsultaDoinDocumentos::" + tipoLog + "::Fin ::"+direccion +"::" + today + endl;
