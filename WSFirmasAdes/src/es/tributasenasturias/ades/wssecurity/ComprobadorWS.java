...
public class ComprobadorWS{
	...
	protected ComprobadorWS(ILog log, Preferencias pref,SOAPHandler<SOAPMessageContext> manejador) {
		this.log=log;
		this.pref=pref;
	...
	public String firmaMensaje (String soapMsg)
	{
		try
		{
			return port.firmarMensaje(soapMsg, pref.getAliasCertificadoWSSecurity());
		}
		catch (Exception ex)
		{
