 ...
 * El fichero de log se llama Application.log y se encuentra en la carpeta Modelo600. 
 */
public final class Logger{

	private final static String LOG_FILE = "Application.log";
	private final static String LOG_DIR = "proyectos//WSANCERT_Modelo600";
	public enum LEVEL {TRACE, DEBUG, INFO, WARNING, ERROR}

	/**
	 * Método sincronizado que realiza log.
	 */
	public final synchronized static void doLog(String message, LEVEL level){
        ...
        try{
            Date today = new Date();
            String completeMsg = "PagoPresentacionModelo600 :: " + today + " :: " + level + " :: " + message;
