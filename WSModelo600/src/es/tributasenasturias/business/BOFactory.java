...
public class BOFactory {
	...
	/**
	 * Instancia un clase de integración de escritura en tablas de modelo.
	 * @return Instancia de clase de integración de escritura
	 * @throws PresentacionException En caso de no poder instanciar.
	 */
	public AltaEscritura newAltaEscritura() throws PresentacionException
	{
		AltaEscritura integra;
		try
		{
			integra=new AltaEscritura();
			if (log!=null)
			{
				integra.setLogger(log);
			}
		...
		{
			throw new PresentacionException (this.getClass().getName()+"::Error al instanciar el objeto de integración de escritura:" + ex.getMessage(),ex);
		}
		return integra;
	}
	/**
