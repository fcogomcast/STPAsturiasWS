 ...
 *       &lt;sequence>
 *         &lt;element name="numSujetos" type="{http://servicios.tributasenasturias.es/Pago600Generico}digito2TypeO"/>
 *         &lt;element name="numTransmitentes" type="{http://servicios.tributasenasturias.es/Pago600Generico}digito2TypeO"/>
 *         &lt;element name="fechaDevengo" type="{http://servicios.tributasenasturias.es/Pago600Generico}fechaTypeO"/>
 *         &lt;element name="fechaDocumento" type="{http://servicios.tributasenasturias.es/Pago600Generico}fechaTypeO"/>
 *         &lt;element name="expAbreviada" type="{http://servicios.tributasenasturias.es/Pago600Generico}expAbreviadaTypeEO"/>
 *         &lt;element name="concepto" type="{http://servicios.tributasenasturias.es/Pago600Generico}conceptoTypeEO"/>
 *         &lt;element name="datoEspecifico" type="{http://servicios.tributasenasturias.es/Pago600Generico}datoEspecificoTypeO"/>
 *         &lt;element name="docNotarial" type="{http://servicios.tributasenasturias.es/Pago600Generico}boolTypeO"/>
 *         &lt;element name="docJudicial" type="{http://servicios.tributasenasturias.es/Pago600Generico}boolTypeO"/>
 *         &lt;element name="docPrivado" type="{http://servicios.tributasenasturias.es/Pago600Generico}boolTypeO"/>
 *         &lt;element name="docAdministrativo" type="{http://servicios.tributasenasturias.es/Pago600Generico}boolTypeO"/>
 *         &lt;element name="docMercantil" type="{http://servicios.tributasenasturias.es/Pago600Generico}boolTypeO"/>
 *         &lt;element name="nifNotario" type="{http://servicios.tributasenasturias.es/Pago600Generico}nifTypeO" minOccurs="0"/>
 *         &lt;element name="nombreNotario" type="{http://servicios.tributasenasturias.es/Pago600Generico}string80TypeO" minOccurs="0"/>
 *         &lt;element name="apellidosNotario" type="{http://servicios.tributasenasturias.es/Pago600Generico}string80TypeO" minOccurs="0"/>
 *         &lt;element name="codNotario" type="{http://servicios.tributasenasturias.es/Pago600Generico}string30TypeO" minOccurs="0"/>
 *         &lt;element name="codNotaria" type="{http://servicios.tributasenasturias.es/Pago600Generico}string30TypeO" minOccurs="0"/>
 *         &lt;element name="provinciaNotario" type="{http://servicios.tributasenasturias.es/Pago600Generico}provinciaTypeEO" minOccurs="0"/>
 *         &lt;element name="provinciaNotarioDesc" type="{http://servicios.tributasenasturias.es/Pago600Generico}provinciaDescTypeEO" minOccurs="0"/>
 *         &lt;element name="municipioNotario" type="{http://servicios.tributasenasturias.es/Pago600Generico}digito5TypeO" minOccurs="0"/>
 *         &lt;element name="municipioNotarioDesc" type="{http://servicios.tributasenasturias.es/Pago600Generico}string50TypeO" minOccurs="0"/>
 *         &lt;element name="numProtocolo" type="{http://servicios.tributasenasturias.es/Pago600Generico}digito13TypeO" minOccurs="0"/>
 *         &lt;element name="numProtocoloBis" type="{http://servicios.tributasenasturias.es/Pago600Generico}digito4TypeO" minOccurs="0"/>
 *         &lt;element name="identificacionAdicional" type="{http://servicios.tributasenasturias.es/Pago600Generico}string70TypeO" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
