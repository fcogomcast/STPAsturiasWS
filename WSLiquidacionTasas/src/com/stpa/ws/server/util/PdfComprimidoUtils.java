...
public class PdfComprimidoUtils {
	...
	public static ByteArrayOutputStream descomprimirPDF(String pdfComprimido) throws Exception
	{
		...
		if(pdfComprimido != null){
			...
			try { 
				...
				throw new Exception(
						msgLog+"Error al descomprimir PDF|"+e.getMessage(),e);
			}
	...
	private static byte[] compress(byte[] input) throws Exception
	{
		String msgLog = "PdfComprimidoUtils.compress|";
		    ...
		    try {
		    	...
		    	throw new Exception(msgLog+" - "+e.getMessage(),e);
		    }
	...
	public static ByteArrayOutputStream decompress(byte[] data) throws Exception
	{
		String msgLog = "PdfComprimidoUtils.compress|";
