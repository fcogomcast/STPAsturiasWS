...
import com.stpa.ws.server.formularios.CampoWS;
import com.stpa.ws.server.formularios.Constantes;
import com.stpa.ws.server.formularios.ObtenerListadosWS;

public class ListadoUtils {

	public static List<Oficina> obtenerOficinas() throws Exception{
		...
		try {
			...
			throw new Exception("ListadoUtils.obtenerOficinas|"+e.getMessage(),e);
		}		
		return oficinas;		
	}

	public static List<Oficina> obtenerOficinasBySaleRecibo(String saleRecibo) throws Exception{
		List<Oficina> oficinas = null;
	 ...
	 * @return
	 */
	public static List<Oficina> obtenerOficinasLiquidadoras() throws Exception{
		List<Oficina> oficinas = null;
		List<Oficina> todasOficinas = obtenerOficinas();
	...
	public static List<Organismo> obtenerOrganismos(String nOrganismo) throws Exception{
		...
		try {
			...
			throw new Exception("ListadoUtils.obtenerOrganismos|"+e.getMessage(),e);
		}		
		return organismos;		
	}
	
	
	public static Organismo obtenerOrganismo(String nOrganismo) throws Exception{
	...
	public static List<InorInfoOrga> obtenerListaInorInfoOrga(String organismo, String tiio) throws Exception{
	...
	public static InorInfoOrga obtenerInorInfoOrga(String nOrganismo, String tiio) throws Exception{
	...
	public static List<String> obtenerNormativa(String tdoc, String sdoc, String tact) throws Exception{
		...
		try {
			...
			throw new Exception("LiteralesUtils.obtenerLiteralNormativa|"+tdoc+"|"+sdoc+"|"+tact,e);
		}		
