...
package es.tributasenasturias.services.ws.imagenesmultas.utils.log.LogHandler;
...
import es.tributasenasturias.services.ws.imagenesmultas.utils.log.GenericAppLogger;
...
public class LogHandler implements SOAPHandler<SOAPMessageContext>{
	...
	private void log(SOAPMessageContext context)
	{
        ...
        Preferencias pref= (Preferencias) context.get(Constantes.PREFERENCIAS);
   	 	if (pref==null) 
   	 	{
   	 		System.out.println("ImagenesMultas::Error en manejador de SOAP_SERVER, no se encuentran preferencias de la llamada");
   	 		return;
   	 	}
   	 	if (idLlamada==null) {
   		 System.out.println ("ImagenesMultas:: Error en manejador de SOAP_SERVER, no se encuentra identificador de llamada");
   		 return;
   	 	}
	    try 
	     {
	         ...
	         String log = "=========================>WSImagenesMultas:: "+ tipoLog + "::" + idLlamada + "::Inicio ::+"+direccion+"::"+ ip + " :: "+today+endl;
	         log += soapMessage + "::" + idLlamada + endl;
	         log +="=========================>WSImagenesMultas::" + tipoLog + "::" + idLlamada + "::Fin ::"+direccion +"::" + today + endl;
