...
public final class Preferencias {
	...
	//Para el código seguro de verificación
    ...
    private final String VALOR_INICIAL_PREF_PROCALMACENADO_INTEGRA = "ANCERT.wsIntegraModelo600";
    private final String VALOR_INICIAL_PREF_PROCALMACENADO_ALTAEXPTE = "ANCERT.wsAltaExpedienteModelo600";
    private final String VALOR_INICIAL_PREF_PROCALMACENADO_ALTADOC = "INTERNET_DOCUMENTOS.AltaDocumento";
    private final String VALOR_INICIAL_PREF_ENDPOINT_ALTAESCRITURA = "http://bus:7001/WSANCERT/ProxyServices/Externos/PXEscrituras";
    private final String VALOR_INICIAL_PREF_ENDPOINT_LANZADOR = "http://bus:7001/WSInternos/ProxyServices/PXLanzador";
    private final String VALOR_INICIAL_PREF_ENDPOINT_PAGO = "http://bus:7001/WSPasarelaPago/ProxyServices/PXPasarelaPagoST";
	...
	private final String VALOR_INICIAL_PREF_DIR_APP = "proyectos/WSANCERT_PagoPresentacion600";
	private final String VALOR_INICIAL_PREF_MODO_LOG = "ALL";
	private final String VALOR_INICIAL_PREF_PROC_CODVERIF = "INTERNET.getCodVerificacion";
