...
import es.tributasenasturias.webservices.clients.PasarelaPagoST;
import es.tributasenasturias.webservices.clients.PasarelaPagoST_Service;
import es.tributasenasturias.webservices.clients.ResultadoPeticion;
	...
	public boolean pagarAutoliquidacion() {
		try {
	        ...
	        try {
	        	...
	        	log.debug("=====PAGO:Error Peticion:"+respuesta.getRespuesta().getError());
