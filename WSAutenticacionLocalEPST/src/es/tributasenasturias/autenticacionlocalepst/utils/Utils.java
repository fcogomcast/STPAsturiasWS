package es.tributasenasturias.autenticacionlocalepst.utils;
	...
	public static final SOAPFaultException createSOAPFaultException(String pFaultString) throws SOAPException
	 {
		 ...
		 {
			 throw new SOAPException ("WSTrasladoMaquina:==> Error grave al construir la excepción SOAP." + ex.getMessage());
		 }
	} 
	/**
