...
public class SoapClientHandler implements SOAPHandler<SOAPMessageContext> {
	...
	private void log(SOAPMessageContext context)
	{
		...
		catch (javax.xml.soap.SOAPException ex)
		{
			...
			SOAPUtils.generateSOAPErrMessage(context.getMessage(), "Error en proceso de comunicación Servicios Smart Multas <--> Servicio Remoto."	, "0002", "SOAP Handler", true);
		}
		...
		catch (PreferenciasException ex)
		{
			...
			System.err.println ("Servicios Smart Multas: Error de preferencias en manejador SOAP ("+SoapClientHandler.class.getName()+":"+ex.getMessage());
			SOAPUtils.generateSOAPErrMessage(context.getMessage(), "Error en proceso de comunicación Servicio Servicios Smart Multas <--> Servicio Remoto."	, "0002", "SOAP Handler", true);
		}
	}
	@Override
